            ...
            new TerserPlugin({
                ...
                terserOptions: {
                    ...
                    output: {
                        comments: false,
                        beautify: false,
                        preamble: `/* Vertical TimeLine for Mendix, Container widget || Version ${pkg.version} || Apache 2 LICENSE || Developer: ${pkg.author} || Please report any issues here: https://github.com/JelteMX/mendix-vertical-timeline/issues */\n`
                        // comments: false
                    },
                    toplevel: false,
                    nameCache: null,
